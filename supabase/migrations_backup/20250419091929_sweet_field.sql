...
BEGIN
  ...
  LOOP
    ...
    INSERT INTO lesson_content (lesson_id, type, content, "order", url)
    VALUES 
      (lesson_id, 'video', 'Introduction to the lesson', 1, 'https://www.youtube.com/embed/dQw4w9WgXcQ'),
      (lesson_id, 'text', 'This is the main content of the lesson. It includes important concepts and examples.', 2, NULL)
    ON CONFLICT DO NOTHING;
